...
const Location = () => {
  return (
    <section className='py-20 bg-center bg-cover bg-purple-700' style={{backgroundImage: "url('../src/assets/location.png')"}}>
        ...
        <FaLocationDot color='black' size={60} className='bg-gray-200 p-4 rounded-full mb-12' />
    
        


        <p className='lg:text-[60px] text-3xl text-white font-mazzard lg:leading-[60px]'>San Francisco <br /> <span className='font-bold'> AI Conference!</span> </p>
        </div>
         ...
         <div className='lg:w-1/2 flex gap-8 flex-wrap'>
          ...
          <div className='bg-white p-4 w-[200px] '>
            ...
            <p className='text-[30px] text-center text-[#5603B4] font-mazzard'>Skilled Speaker</p>
          ...
          <div className= 'relative lg:top-10 bg-[#5603B4] p-4 w-[200px] '>
            ...
            <p className='text-[30px] text-center text-white font-mazzard'>Networking with Industry</p>

          </div>

          <div className='bg-[#5603B4] p-4 w-[200px] '>
            <p className='text-[95px] text-center font-bold text-white'>4</p>
            <p className='text-[30px] text-center text-white font-mazzard'>Days Full
of Inspiration</p>
          ...
          <div className='bg-white p-4 w-[200px] relative top-10'>
            ...
            <p className='text-[30px] text-center text-[#5603B4] font-mazzard'>Unique Workshop</p>
